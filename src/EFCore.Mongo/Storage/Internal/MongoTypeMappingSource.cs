...
//using Microsoft.EntityFrameworkCore.Mongo.ChangeTracking.Internal;
...
{
    private readonly Dictionary<Type, MongoTypeMapping> _clrTypeMappings;
    ...
    {
        _clrTypeMappings
            = new Dictionary<Type, MongoTypeMapping> { { typeof(BsonDocument), new MongoTypeMapping(typeof(BsonDocument)) } };
    }
    ...
    private static CoreTypeMapping? FindCollectionMapping(in TypeMappingInfo mappingInfo)
    {
        ...
        if (clrType.IsArray)
        {
            ...
            return elementMapping == null
                ? null
                : new MongoTypeMapping(clrType, CreateArrayComparer(elementMapping, elementType));
        }
            ...
            && !clrType.IsGenericTypeDefinition)
        {
                ...
                || genericTypeDefinition == typeof(IReadOnlyList<>))
            {
                ...
                return elementMapping == null
                    ? null
                    : new MongoTypeMapping(clrType, CreateListComparer(elementMapping, elementType, clrType));
            }
                ...
                || genericTypeDefinition == typeof(IReadOnlyDictionary<,>))
            {
                ...
                return elementMapping == null
                    ? null
                    : new MongoTypeMapping(clrType, CreateStringDictionaryComparer(elementMapping, elementType, clrType));
            }
        }
    ...
    {
        return ValueComparer.CreateDefault(elementType, favorStructuralComparisons: true);
