...
/// </summary>
public class MongoExecutionStrategyFactory : IExecutionStrategyFactory
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public MongoExecutionStrategyFactory(ExecutionStrategyDependencies dependencies)
    {
        Dependencies = dependencies;

        _createExecutionStrategy = dependencies.Options.FindExtension<MongoOptionsExtension>()?.ExecutionStrategyFactory
    ...
    protected virtual IExecutionStrategy CreateDefaultStrategy(ExecutionStrategyDependencies dependencies)
        => new MongoExecutionStrategy(dependencies);
