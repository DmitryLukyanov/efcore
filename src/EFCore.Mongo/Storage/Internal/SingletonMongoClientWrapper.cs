...
/// </summary>
public class SingletonMongoClientWrapper : ISingletonMongoClientWrapper
{
    ...
    //private readonly TokenCredential? _tokenCredential;   // _tokenCredential => MongoCredentials
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public SingletonMongoClientWrapper(IMongoSingletonOptions options)
    {
