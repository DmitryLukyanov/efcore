...
using System.Text;
//using Azure.Core;
//using Microsoft.EntityFrameworkCore.Mongo.Internal;
...
public class MongoOptionsExtension : IDbContextOptionsExtension
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithAccountEndpoint(string? accountEndpoint)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithAccountKey(string? accountKey)
    {
    ...
    /////     doing so can result in application failures when updating to a new Entity Framework Core release.
    ///// </summary>
    //public virtual MongoOptionsExtension WithTokenCredential(TokenCredential? tokenCredential)
    //{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithDatabaseName(string database)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithRegion(string? region)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithLimitToEndpoint(bool enable)
    {
        var clone = Clone();
    ...
    /////     doing so can result in application failures when updating to a new Entity Framework Core release.
    ///// </summary>
    //public virtual MongoOptionsExtension WithConnectionMode(ConnectionMode connectionMode)
    //{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithWebProxy(IWebProxy? proxy)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithRequestTimeout(TimeSpan? timeout)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithOpenTcpConnectionTimeout(TimeSpan? timeout)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithIdleTcpConnectionTimeout(TimeSpan? timeout)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithGatewayModeMaxConnectionLimit(int? connectionLimit)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithMaxTcpConnectionsPerEndpoint(int? connectionLimit)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithMaxRequestsPerTcpConnection(int? requestLimit)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension ContentResponseOnWriteEnabled(bool enabled)
    {
        var clone = Clone();
    ...
    public virtual MongoOptionsExtension WithExecutionStrategyFactory(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoOptionsExtension WithHttpClientFactory(Func<HttpClient>? httpClientFactory)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual MongoOptionsExtension Clone()
        => new(this);
    ...
    private sealed class ExtensionInfo : DbContextOptionsExtensionInfo
    {
        ...
        private new MongoOptionsExtension Extension
            => (MongoOptionsExtension)base.Extension;
