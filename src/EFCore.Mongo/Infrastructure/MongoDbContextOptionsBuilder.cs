...
///         <see cref="O:MongoDbContextOptionsExtensions.UseCosmos{TContext}" />
...
public class MongoDbContextOptionsBuilder : IMongoDbContextOptionsBuilderInfrastructure
{
    ...
    /// <inheritdoc />
    DbContextOptionsBuilder IMongoDbContextOptionsBuilderInfrastructure.OptionsBuilder
        => _optionsBuilder;
    ...
    public virtual MongoDbContextOptionsBuilder Region(string region)
    ...
    public virtual MongoDbContextOptionsBuilder LimitToEndpoint(bool enable = true)
    ...
    public virtual MongoDbContextOptionsBuilder HttpClientFactory(Func<HttpClient>? httpClientFactory)
    ...
    //public virtual MongoDbContextOptionsBuilder ConnectionMode(ConnectionMode connectionMode)
    ...
    public virtual MongoDbContextOptionsBuilder WebProxy(IWebProxy proxy)
    ...
    public virtual MongoDbContextOptionsBuilder RequestTimeout(TimeSpan timeout)
    ...
    public virtual MongoDbContextOptionsBuilder OpenTcpConnectionTimeout(TimeSpan timeout)
    ...
    public virtual MongoDbContextOptionsBuilder IdleTcpConnectionTimeout(TimeSpan timeout)
    ...
    public virtual MongoDbContextOptionsBuilder GatewayModeMaxConnectionLimit(int connectionLimit)
    ...
    public virtual MongoDbContextOptionsBuilder MaxTcpConnectionsPerEndpoint(int connectionLimit)
    ...
    public virtual MongoDbContextOptionsBuilder MaxRequestsPerTcpConnection(int requestLimit)
    ...
    public virtual MongoDbContextOptionsBuilder ContentResponseOnWriteEnabled(bool enabled = true)
    ...
    protected virtual MongoDbContextOptionsBuilder WithOption(Func<MongoOptionsExtension, MongoOptionsExtension> setAction)
    {
        ((IDbContextOptionsBuilderInfrastructure)_optionsBuilder).AddOrUpdateExtension(
            setAction(_optionsBuilder.Options.FindExtension<MongoOptionsExtension>() ?? new MongoOptionsExtension()));
