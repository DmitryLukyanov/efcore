...
public static class MongoDbContextOptionsExtensions
{
    ...
    /// <param name="accountKey">The account key.</param>
    /// <param name="databaseName">The database name.</param>
    /// <param name="mongoOptionsAction">An optional action to allow additional Cosmos-specific configuration.</param>
    /// <returns>The options builder so that further configuration can be chained.</returns>
        ...
        Action<MongoDbContextOptionsBuilder>? cosmosOptionsAction = null)
    {
        ...
        cosmosOptionsAction?.Invoke(new MongoDbContextOptionsBuilder(optionsBuilder));
