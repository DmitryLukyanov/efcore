...
/// </summary>
public class MqlConstantExpression : MqlExpression
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public MqlConstantExpression(ConstantExpression constantExpression, CoreTypeMapping? typeMapping)
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MqlExpression ApplyTypeMapping(CoreTypeMapping? typeMapping)
        => new MqlConstantExpression(_constantExpression, typeMapping ?? TypeMapping);
        ...
        ExpressionPrinter expressionPrinter)
    {
        ...
        else
        {
            ...
            expressionPrinter.Append(jToken == null ? "null" : jToken.AsString);
        }
    }
    ...
    private BsonValue? GenerateJToken(object? value, CoreTypeMapping? typeMapping)
    {
        ...
        return (value as BsonValue) ?? BsonValue.Create(value);//.FromObject(value, CosmosClientWrapper.Serializer);
    }
    ...
    public override bool Equals(object? obj)
        => obj != null
            && (ReferenceEquals(this, obj)
                || obj is MqlConstantExpression sqlConstantExpression
                && Equals(sqlConstantExpression));

    private bool Equals(MqlConstantExpression sqlConstantExpression)
