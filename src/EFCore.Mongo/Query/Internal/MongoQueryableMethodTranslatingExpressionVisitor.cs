...
/// </summary>
public class MongoQueryableMethodTranslatingExpressionVisitor : QueryableMethodTranslatingExpressionVisitor
{
    private readonly QueryCompilationContext _queryCompilationContext;
    private readonly IMqlExpressionFactory _mqlExpressionFactory;
    private readonly IMemberTranslatorProvider _memberTranslatorProvider;
    private readonly IMethodCallTranslatorProvider _methodCallTranslatorProvider;
    private readonly MongoMqlTranslatingExpressionVisitor _mqlTranslator;
    private readonly MongoProjectionBindingExpressionVisitor _projectionBindingExpressionVisitor;
        ...
        : base(dependencies, queryCompilationContext, subquery: false)
    {
        ...
        _mqlTranslator = new MongoMqlTranslatingExpressionVisitor(
            queryCompilationContext,
            _mqlExpressionFactory,
            _memberTranslatorProvider,
            _methodCallTranslatorProvider);
        _projectionBindingExpressionVisitor =
            new MongoProjectionBindingExpressionVisitor(_queryCompilationContext.Model, _mqlTranslator);
    }
        ...
        : base(parentVisitor.Dependencies, parentVisitor.QueryCompilationContext, subquery: true)
    {
        ...
        _mqlExpressionFactory = parentVisitor._mqlExpressionFactory;
        _mqlTranslator = new MongoMqlTranslatingExpressionVisitor(
            QueryCompilationContext,
            _mqlExpressionFactory,
            _memberTranslatorProvider,
    ...
    protected override Expression VisitExtension(Expression extensionExpression)
    {
        ...
        {
            case FromMqlQueryRootExpression fromSqlQueryRootExpression:
                return CreateShapedQueryExpression(
                    fromSqlQueryRootExpression.EntityType,
                    _mqlExpressionFactory.Select(
                        fromSqlQueryRootExpression.EntityType,
                        fromSqlQueryRootExpression.Mql,
    ...
    {
        var selectExpression = _mqlExpressionFactory.Select(entityType);
    ...
    protected override ShapedQueryExpression TranslateAverage(ShapedQueryExpression source, LambdaExpression selector, Type resultType)
    {
        ...
        var projection = (MqlExpression)selectExpression.GetMappedProjection(new ProjectionMember());
        projection = _mqlExpressionFactory.Function(
    ...
    protected override ShapedQueryExpression TranslateCount(ShapedQueryExpression source, LambdaExpression predicate)
    {
        ...
        var translation = _mqlExpressionFactory.ApplyDefaultTypeMapping(
            _mqlExpressionFactory.Function("COUNT", new[] { _mqlExpressionFactory.Constant(1) }, typeof(int)));
    ...
    protected override ShapedQueryExpression TranslateLongCount(ShapedQueryExpression source, LambdaExpression predicate)
    {
        ...
        var translation = _mqlExpressionFactory.ApplyDefaultTypeMapping(
            _mqlExpressionFactory.Function("COUNT", new[] { _mqlExpressionFactory.Constant(1) }, typeof(long)));
        var projectionMapping = new Dictionary<ProjectionMember, Expression> { { new ProjectionMember(), translation } };
    ...
    protected override ShapedQueryExpression TranslateMax(ShapedQueryExpression source, LambdaExpression selector, Type resultType)
    {
        ...
        projection = _mqlExpressionFactory.Function("MAX", new[] { projection }, resultType, projection.TypeMapping);
    ...
    protected override ShapedQueryExpression TranslateMin(ShapedQueryExpression source, LambdaExpression selector, Type resultType)
    {
        ...
        projection = _mqlExpressionFactory.Function("MIN", new[] { projection }, resultType, projection.TypeMapping);
    ...
    protected override ShapedQueryExpression TranslateOfType(ShapedQueryExpression source, Type resultType)
    {
        if (source.ShaperExpression is EntityShaperExpression entityShaperExpression)
        {
            ...
            var selectExpression = (SelectExpression)source.QueryExpression;
            if (!(translation is MqlConstantExpression sqlConstantExpression
    ...
    private MqlExpression TranslateExpression(Expression expression)
    {
        var translation = _mqlTranslator.Translate(expression);
        if (translation == null && _mqlTranslator.TranslationErrorDetails != null)
        {
            AddTranslationErrorDetails(_mqlTranslator.TranslationErrorDetails);
        }

        return translation;
    }

    private MqlExpression TranslateLambdaExpression(
