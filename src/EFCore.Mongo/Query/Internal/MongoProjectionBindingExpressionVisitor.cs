...
/// </summary>
public class MongoProjectionBindingExpressionVisitor : ExpressionVisitor
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public MongoProjectionBindingExpressionVisitor(
        IModel model,
        MongoMqlTranslatingExpressionVisitor mqlTranslator)
    {
        _model = model;
        _mqlTranslator = mqlTranslator;
    }
