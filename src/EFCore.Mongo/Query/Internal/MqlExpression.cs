...
/// </summary>
public abstract class MqlExpression : Expression, IPrintableExpression
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected MqlExpression(Type type, CoreTypeMapping? typeMapping)
    {
        Type = type;
    ...
    public override bool Equals(object? obj)
        => obj != null
            && (ReferenceEquals(this, obj)
                || obj is MqlExpression sqlExpression
                && Equals(sqlExpression));

    private bool Equals(MqlExpression sqlExpression)
