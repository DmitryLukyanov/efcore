...
public class OrderingExpression : Expression, IPrintableExpression
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public OrderingExpression(MqlExpression expression, bool ascending)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MqlExpression Expression { get; }
    ...
    protected override Expression VisitChildren(ExpressionVisitor visitor)
        => Update((MqlExpression)visitor.Visit(Expression));
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual OrderingExpression Update(MqlExpression expression)
        => expression != Expression
